...
class WaterViewSet(Base):
    ...
    def create(self, request):
        ...
        try:
            ...
            result = water_collection.insert_one(water_data)

            water_data["_id"] = str(result.inserted_id)

            response = Response.ok(format_response_data(200, "Thêm dữ liệu thành công", water_data))
            return self.send_response(request, response)
